...
const TopUp = () => {
  ...
  return (
    <div className='cyber-topup-page w-full max-w-7xl mx-auto relative min-h-screen lg:min-h-0 mt-[60px] px-2'>
      {/* 划转模态框 */}
      <TransferModal
        t={t}
      ...
      {/* 主布局区域 */}
      <div className='cyber-topup-grid grid grid-cols-1 lg:grid-cols-2 gap-6'>
        <RechargeCard
          t={t}
